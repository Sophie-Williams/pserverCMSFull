    ...
    'bjyauthorize' => [
        ...
        'guards' => [
            ...
            BjyAuthorize\Guard\Controller::class => [
                ...
                ['controller' => CoreController\AuthController::class, 'roles' => ['guest', 'user', 'admin']],
                ...
                ['controller' => CoreController\AccountController::class, 'roles' => ['user', 'admin']],
                ['controller' => CoreController\DonateController::class, 'roles' => ['user', 'admin']],
                ['controller' => PanelController\CharacterController::class, 'roles' => ['user', 'admin']],
                ['controller' => PanelController\VoteController::class, 'roles' => ['user', 'admin']],
